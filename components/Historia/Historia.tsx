...
const Historia = () => {
  return (
    <div className="bg-opacity-100 p-4">
      <h3 className="text-black header-font font-bold text-left text-4xl p-4">
        {" "}
        Nuestra Historia{" "}
      </h3>
      <article className="bg-white history-article p-4 paragraph-font rounded shadow-xl m-4 w-full">
        ...
        <p className="ml-2">
          ...
          del Club Atlético Pacífico, encabezada por su presidente Francisco
          Mantelli y otros socios fundadores ocupando los diferentes cargos.
          Según las fuentes históricas, los colores que identificaron a la
          institución tuvieron origen en el amarillo por los empleados del
          Correo y el negro por los empleados del Ferrocarril. El nombre hacía
          referencia al histórico proyecto nacional de «construcción del
